...
{ 
    ...
    private GRAVITY = 0.1;
    private BOUNCE_FACTOR = 0.3;

    private particles = new Array<Ball>();
    private maxBall = 1000;
    ...
    public applyVelocity(delta : number) { 
    ...
    public borderCollisionOverlapFix() { 
        this.particles.forEach(x => {
            let fixVx = 0;
            let fixVy = 0;
    ...
    public applyGravity(delta : number) { 
        this.particles.forEach(x => { 
    ...
    public particleCollision(delta: number) { 
    ...
    public GetParticles(): Array<Ball> { 
